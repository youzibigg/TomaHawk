...
- **Primary entry points:** `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/index.html`, `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/src/app.js`, `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/src/sim.js`
...
```text
/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/
├── README.md
├── CHANGELOG.md
├── package.json
├── server.mjs
...
```bash
cd /home/runner/work/tomahawk/tomahawk/Panther114/tomahawk
```
...
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/ARCHITECTURE.md` — runtime structure, module boundaries, rendering layers.
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/DATA_MODEL.md` — object shapes, unit conventions, missile and ship fields.
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/SIMULATION_ASSUMPTIONS.md` — modeling assumptions and abstraction policy.
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/SOURCES.md` — public-source references and data policy.
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/ROADMAP.md` — future upgrade ideas and longer-term direction.
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/CHANGELOG.md` — formal release history beginning with `v0.1`.
...
- **主要入口：** `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/index.html`、`/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/src/app.js`、`/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/src/sim.js`
...
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/ARCHITECTURE.md`：运行结构、模块边界、渲染层次。
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/DATA_MODEL.md`：对象结构、单位规范、舰艇与导弹字段。
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/SIMULATION_ASSUMPTIONS.md`：建模假设与抽象原则。
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/SOURCES.md`：公开来源与数据政策。
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/docs/ROADMAP.md`：后续方向与扩展计划。
- `/home/runner/work/tomahawk/tomahawk/Panther114/tomahawk/CHANGELOG.md`：从 `v0.1` 开始的正式版本记录。
